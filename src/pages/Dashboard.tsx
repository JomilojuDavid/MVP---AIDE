      ...
      <main className="flex-1 md:ml-64 pt-24 px-6">
        <div className="max-w-6xl mx-auto space-y-4">
          ...
          >
            ...
            {/* Progress Bar */}
            <div className="relative w-full h-4 bg-[#FFD9D9] mb-4 rounded-full overflow-hidden">
              <div
            ...
            {/* Stages */}
            <div className="flex flex-wrap gap-3 items-center text-base font-medium text-foreground">
              <span>Awareness</span>
              <span>→</span>
              <span>Intention</span>
              <span>→</span>
          ...
          >
            ...
            <div
              ...
              className="cursor-pointer bg-primary border-2 border-[#F3C17E] p-4"
            >
