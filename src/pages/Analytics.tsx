        ...
        <div className="max-w-4xl mx-auto w-full flex flex-col gap-3 flex-1">
          ...
          >
            ...
            <div className="bg-secondary py-3 px-4">
              ...
              <p className="text-4xl font-bold text-foreground">0<span className="text-xl">hr</span></p>
            </div>
            ...
            <div className="bg-white py-3 px-4">
              ...
              <p className="text-4xl font-bold text-foreground">0<span className="text-xl">%</span></p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-lg font-bold text-foreground">Goal Tracker</h3>
            </div>
