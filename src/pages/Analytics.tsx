      ...
      <main className="flex-1 md:ml-64 pt-8 px-6 flex flex-col">
        <div className="max-w-4xl mx-auto w-full flex flex-col gap-3 flex-1">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl py-5 px-8 hover-bubble"
          >
          ...
          >
            <div className="bg-white py-4 px-5 hover-bubble">
            ...
            <div className="bg-secondary py-4 px-5 hover-bubble">
          ...
          <motion.div
            ...
            className="bg-white py-5 px-8 hover-bubble"
          >
          ...
          <motion.div
            ...
            className="bg-white py-5 px-8 flex-1 hover-bubble"
          >
